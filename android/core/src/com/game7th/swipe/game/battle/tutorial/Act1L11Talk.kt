        ...
        when (event) {
            is InternalBattleEvent.BattleStartedEvent -> {
                ...
                if (!shown) {
                    ...
                    screen.showDialog("vp_personage_gladiator", "Antoxa", game.context.texts["ttr_a1l11_fb_1"]!!) {
                        screen.showDialog("vp_dryad", "Dryad", game.context.texts["ttr_a1l11_fb_2"]!!) {
                            screen.showDialog("vp_personage_gladiator", "Antoxa", game.context.texts["ttr_a1l11_fb_3"]!!) {
                                screen.showDialog("vp_strange_figure", "Strange Figure", game.context.texts["ttr_a1l11_fb_4"]!!) {
