    ...
    override suspend fun process(event: InternalBattleEvent, unit: BattleUnit) {
        when (event) {
            is InternalBattleEvent.BattleStartedEvent -> {
                ...
                screen.showDialog("vp_strange_figure", "Strange Figure", game.context.texts["ttr_a1l3_fb_1"]!!) {
                    screen.showDialog("vp_personage_gladiator", "Antoxa", game.context.texts["ttr_a1l3_fb_2"]!!) {
                        screen.showDialog("vp_strange_figure", "Strange Figure", game.context.texts["ttr_a1l3_fb_3"]!!) {
